...
class Condition(object):
    ...
    def setup(self):
        ...
        QC = pd.read_csv(savewd + "\\finalcodes.csv")
        QC_ID = QC['ID']
        rowcount = 0
        QCs = dict()
        ...
        for names in self.folders: # e.g. '151202a'
            ...
            files = os.listdir(swd + '\\download-3\\' + names)
            file_name = swd + '\\download-3'
...
# Pareto frontier (reference set) hard-coded in to eliminate small variations.
...
def group_preference(test1lev, test2lev, test3lev, flag):
    ...
    if flag == 0:
        for k in range(len(test1lev['obj1'])):
            ...
            scores_utirel['1D1L'].append(score_utirel_1L((test1lev['obj1'][k])))

            scores_utirel['1D2L'].append(score_utirel_2L((test2lev['obj1'][k]).values[0]))
            scores_utirel['1D3L'].append(score_utirel_3L((test3lev['obj1'][k]).values[0]))
            
            scores_utirel['2D1L'].append(score_utirel_1L((test1lev['obj2'][k])))
            scores_utirel['2D2L'].append(score_utirel_2L((test2lev['obj2'][k]).values[0]))
            scores_utirel['2D3L'].append(score_utirel_3L((test3lev['obj2'][k]).values[0]))
            
            scores_utirel['3D1L'].append(score_utirel_1L((test1lev['obj3'][k])))
            scores_utirel['3D2L'].append(score_utirel_2L((test2lev['obj3'][k]).values[0]))
            scores_utirel['3D3L'].append(score_utirel_3L((test3lev['obj3'][k]).values[0]))
            
            scores_utipho['1D1L'].append(score_utipho_1L((test1lev['obj1'][k])))
            scores_utipho['1D2L'].append(score_utipho_2L((test2lev['obj1'][k]).values[0]))
            scores_utipho['1D3L'].append(score_utipho_3L((test3lev['obj1'][k]).values[0]))
            
            scores_utipho['2D1L'].append(score_utipho_1L((test1lev['obj2'][k])))
            scores_utipho['2D2L'].append(score_utipho_2L((test2lev['obj2'][k]).values[0]))
            scores_utipho['2D3L'].append(score_utipho_3L((test3lev['obj2'][k]).values[0]))
            
            scores_utipho['3D1L'].append(score_utipho_1L((test1lev['obj3'][k])))
            scores_utipho['3D2L'].append(score_utipho_2L((test2lev['obj3'][k]).values[0]))
            scores_utipho['3D3L'].append(score_utipho_3L((test3lev['obj3'][k]).values[0]))
    else:
        for k in range(len(test1lev['obj1'])):
            # One objective, reliability
            scores_utirel['1D1L'].append(score_utirel_1L((test1lev['obj1'][k]/100)))
            scores_utirel['1D2L'].append(score_utirel_2L((test2lev['obj1'][k]).values[0]/100))
            scores_utirel['1D3L'].append(score_utirel_3L((test3lev['obj1'][k]).values[0]/100))
            
            # Two objectives, rel
            scores_utirel['2D1L'].append(score_utirel_1L((test1lev['obj2'][k]/100)))
            if issubclass(type(test2lev['obj2'][k]), np.ndarray):
                scores_utirel['2D2L'].append(-99)
                print(type(test2lev['obj2'][k]))
            else:
                scores_utirel['2D2L'].append(score_utirel_2L((test2lev['obj2'][k]).values[0]/100))
            scores_utirel['2D3L'].append(score_utirel_3L((test3lev['obj2'][k]).values[0]/100))
            
            # 3 objectives, reliability
            scores_utirel['3D1L'].append(score_utirel_1L((test1lev['obj3'][k]/100)))
            if issubclass(type(test2lev['obj3'][k]), np.ndarray):
                scores_utirel['3D2L'].append(-99)
                print(type(test2lev['obj3'][k]))
            else:
                scores_utirel['3D2L'].append(score_utirel_2L((test2lev['obj3'][k]).values[0]/100))
            scores_utirel['3D3L'].append(score_utirel_3L((test3lev['obj3'][k]).values[0]/100))
            
            # One, objective, pho
            scores_utipho['1D1L'].append(score_utipho_1L((test1lev['obj1'][k]/100)))
            if issubclass(type(test2lev['obj1'][k]), np.ndarray):
                scores_utipho['1D2L'].append(-99)
                print(type(test2lev['obj1'][k]))
            else:
                scores_utipho['1D2L'].append(score_utipho_2L((test2lev['obj1'][k]).values[0]/100))
            scores_utipho['1D3L'].append(score_utipho_3L((test3lev['obj1'][k]).values[0]/100))
            
            # Two objectives, pho
            scores_utipho['2D1L'].append(score_utipho_1L((test1lev['obj2'][k]/100)))
            if issubclass(type(test2lev['obj2'][k]), np.ndarray):
                scores_utipho['2D2L'].append(-99)
                print(type(test2lev['obj2'][k]))
            else:
                scores_utipho['2D2L'].append(score_utipho_2L((test2lev['obj2'][k]).values[0]/100))
            scores_utipho['2D3L'].append(score_utipho_3L((test3lev['obj2'][k]).values[0]/100))
            
            # Three objectives, pho
            scores_utipho['3D1L'].append(score_utipho_1L((test1lev['obj3'][k]/100)))
            scores_utipho['3D2L'].append(score_utipho_2L((test2lev['obj3'][k]).values[0]/100))
            scores_utipho['3D3L'].append(score_utipho_3L((test3lev['obj3'][k]).values[0]/100))
...
#    
    ...
    plt.savefig((savewd + '\\fig10.pdf'), dpi=300, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=False, bbox_inches=None, pad_inches=0.1,
        frameon=None, metadata=None)
    
    plt.savefig((savewd + '\\fig10.png'), dpi=300, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=False, bbox_inches=None, pad_inches=0.1,
        frameon=None, metadata=None)
...
#    
#    plt.savefig((savewd + '\\fig9.pdf'), dpi=300, facecolor='w', edgecolor='w',
#        orientation='portrait', papertype=None, format=None,
#        transparent=False, bbox_inches=None, pad_inches=0.1,
#        frameon=None, metadata=None)
#    
...
#    plt.legend((p1[0], p2[0]), ('Lake Problem', 'Neutral Problem'))
#    
#    plt.savefig((savewd + '\\fig8.pdf'), dpi=300, facecolor='w', edgecolor='w',
#        orientation='portrait', papertype=None, format=None,
#        transparent=False, bbox_inches=None, pad_inches=0.1,
#        frameon=None, metadata=None)
#    
#    plt.savefig((savewd + '\\fig8.png'), dpi=300, facecolor='w', edgecolor='w',
#        orientation='portrait', papertype=None, format=None,
#        transparent=False, bbox_inches=None, pad_inches=0.1,
#        frameon=None, metadata=None)
#    
...
#    
    ...
    plt.savefig(savewd + '\\fig6.pdf', dpi=300, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=False, bbox_inches=None, pad_inches=0.1,
        frameon=None, metadata=None)
...
#
    ...
    plt.savefig((savewd + '\\fig1.pdf'), dpi=300, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=False, bbox_inches=None, pad_inches=0.1,
        frameon=None, metadata=None)
    
    plt.savefig((savewd + '\\fig1.png'), dpi=300, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=False, bbox_inches=None, pad_inches=0.1,
        frameon=None, metadata=None)
...
#    df2L = df2L.reindex(range(len(df2L)))
    ...
    plt.savefig((savewd + '\\fig6.png'), dpi=300, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=False, bbox_inches=None, pad_inches=0.1,
        frameon=None, metadata=None)
...
#    for t, l in zip(g._legend.texts, new_labels): t.set_text(l)
    ...
    plt.savefig((savewd + '\\fig7.pdf'), dpi=300, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=False, bbox_inches=None, pad_inches=0.1,
        frameon=None, metadata=None)
    
    plt.savefig((savewd + '\\fig7.png'), dpi=300, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=False, bbox_inches=None, pad_inches=0.1,
        frameon=None, metadata=None)
...
#    df1D['Levers'] = df1D['Levers'].astype(int)
    ...
    plt.savefig((savewd + '\\fig9.png'), dpi=300, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=False, bbox_inches=None, pad_inches=0.1,
        frameon=None, metadata=None)
...
#    df3L = df3L.reindex(range(len(df3L)))
    ...
    plt.savefig((savewd + '\\fig5.pdf'), dpi=300, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=False, bbox_inches=None, pad_inches=0.1,
        frameon=None, metadata=None)
    
    plt.savefig((savewd + '\\fig5.png'), dpi=300, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=False, bbox_inches=None, pad_inches=0.1,
        frameon=None, metadata=None)
